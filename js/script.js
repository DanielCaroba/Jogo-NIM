...
element.innerHTML = "Jogo do Nim";
document.getElementById("jogar").innerHTML = "Jogar!";
document.getElementById("jogar-regras").innerHTML = "Como Jogar?";
document.getElementById("jogador1").innerHTML = "Um Jogador";
document.getElementById("jogador2").innerHTML = "Dois Jogadores";
...
function fosforosPontuacao(primeiraPeca, ultimaPeca) {
    ...
    for (var i = primeiraPeca; i <= ultimaPeca; i++) {
        if(fosforosEstado[i-1] === 1) {
            ...
            document.getElementById(fosforosRemovidas).style.backgroundColor = "rgb(255,0,0)";
            document.getElementById(fosforosRemovidas).style.border = "1px solid black";
        }
    } 
}
...
function fosforosSemPontuacao(primeiraPeca, ultimaPeca) {
    ...
    for (var i = primeiraPeca; i <= ultimaPeca; i++) {
        ...
        document.getElementById(fosforosRemovidas).style.removeProperty("border");
    } 
}
